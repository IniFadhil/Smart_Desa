...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('ds_sk_riwayat_tanah', function (Blueprint $table) {
            ...
            $table->string('desa_id', 50)->index('ds_sk_riwayat_tanah_desa_id_foreign');
            $table->string('user_id', 50)->index('ds_sk_riwayat_tanah_user_id_foreign');
            ...
            $table->string('kasi_id')->nullable()->index('ds_sk_riwayat_tanah_kasi_id_foreign');
