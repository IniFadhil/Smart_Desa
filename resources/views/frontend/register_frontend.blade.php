        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="mt-4">
                ...
                <x-text-input id="no_telepon" class="block mt-1 w-full" type="text" name="no_telepon"
                    :value="old('no_telepon')" required placeholder="Masukkan No. Telepon Anda" />
            ...
            <div class="mt-4">
                ...
                <textarea id="alamat" name="alamat"
                    ...
                    required placeholder="Masukkan Alamat Lengkap Anda">{{ old('alamat') }}</textarea>
            ...
            <div class="mt-4">
                ...
                <x-text-input id="password" class="block mt-1 w-full" type="password" name="password" required
                    autocomplete="new-password" placeholder="Buat Kata Sandi" />
