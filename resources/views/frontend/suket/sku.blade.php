    ...
    @section('content')
        ...
        <div class="container mx-auto p-6">
            <div class="bg-white rounded-lg shadow-md p-8 mb-6">
                <h1 class="text-3xl font-bold text-gray-800 mb-4 text-center">Pengajuan Surat Keterangan Usaha</h1>
                <p class="text-gray-600 text-center mb-8">
                    Mohon lengkapi semua informasi yang diperlukan di bawah ini untuk pengajuan Surat Keterangan Usaha.
                </p>
                    ...
                    <div class="p-6 bg-green-50 rounded-lg shadow-sm border border-green-200">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <x-text-input id="tempat_lahir_pemohon" name="tempat_lahir_pemohon" type="text" class="mt-1 block w-full" placeholder="Silahkan untuk memasukan Tempat Lahir" required />
                            ...
                            <div class="md:col-span-2">
                                ...
                                <x-text-input id="nama_usaha" name="nama_usaha" type="text" class="mt-1 block w-full" placeholder="Silahkan untuk memasukan nama usaha" required />
