<x-backend.layouts.app>
    ...
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-2xl font-semibold text-gray-700">Daftar Berita</h1>
        <a href="{{ route('backend.informasi.berita.create') }}"
                    ...
                    @forelse($beritas as $berita)
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">
                                {{ Str::limit($berita->title, 30) }}</td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                {{ Str::limit($berita->short_content, 50) }}</td>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-center">
                                <div class="flex justify-center items-center space-x-4">
                                    <a href="{{ route('backend.informasi.berita.show', $berita) }}"
                                    ...
                                    <form action="{{ route('backend.informasi.berita.toggleStatus', $berita) }}"
