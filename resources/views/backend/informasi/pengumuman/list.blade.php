<x-backend.layouts.app>
    ...
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-2xl font-semibold text-gray-700">Daftar Pengumuman</h1>
        <a href="{{ route('backend.informasi.pengumuman.create') }}"
                    ...
                    @forelse($pengumumans as $pengumuman)
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">
                                {{ Str::limit($pengumuman->title, 30) }}</td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                {{ Str::limit($pengumuman->short_description, 40) }}</td>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-center">
                                <div class="flex justify-center items-center space-x-4">
                                    <a href="{{ route('backend.informasi.pengumuman.show', $pengumuman) }}"
                                    ...
                                    <form action="{{ route('backend.informasi.pengumuman.toggleStatus', $pengumuman) }}"
