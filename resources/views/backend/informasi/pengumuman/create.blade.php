<x-backend.layouts.app>
    ...
    <div class="max-w-4xl mx-auto">
        <div class="bg-white shadow-md rounded-lg p-8">
            <h1 class="text-2xl font-semibold text-gray-700 mb-6">Tambah Pengumuman Baru</h1>
            <form action="{{ route('backend.informasi.pengumuman.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="space-y-6">
                    <div>
                    ...
                    <div>
                        <label for="img" class="block text-sm font-medium text-gray-700 mb-1">Gambar
                            (Opsional)</label>
