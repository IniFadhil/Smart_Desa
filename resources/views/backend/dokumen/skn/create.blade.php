            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4>Form Tambah Pengajuan Surat Keterangan Nikah</h4>
                    </div>
                    <div class="card-body">
                        <form class="forms-sample" method="post" enctype="multipart/form-data" id="mainform">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <select name="status_perkawinan" id="" class="form-control {{($errors->has('status_perkawinan'))?'is-invalid':''}}" >
                                        ...
                                        <option value="belum menikah" {{(old('status_perkawinan')=='belum menikah')?
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <select name="warga_negara" id="" class="form-control {{($errors->has('warga_negara'))?'is-invalid':''}}" >
                                        <option value="">Pilih Warga Negara</option>
                                        <option value="indonesia" {{(old('warga_negara')=='indonesia')?
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <textarea name="alamat" id="" cols="30" rows="10"
                                        class="form-control summernote {{($errors->has('alamat'))?'is-invalid':''}}">{{old('alamat')}}</textarea>
                            ...
                            <div class="form-group mb-0 row">
                                ...
                                <div class="col-sm-9">
                                    <img src="{{asset('backend/images/default.jpg')}}" id="preview-akta_cerai" alt=""
                                        width="200px">
