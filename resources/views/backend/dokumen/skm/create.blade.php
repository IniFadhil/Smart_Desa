...
<section class="section">
    <div class="section-header">
        ...
        <div class="section-header-breadcrumb">
            ...
            <div class="breadcrumb-item"><a href="{{route('backend.dokumen.skk')}}"> Surat Keterangan Kematian</a></div>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4>Form Tambah Pengajuan Surat Keterangan Kematian</h4>
                    </div>
                    <div class="card-body">
                        <form class="forms-sample" method="post" enctype="multipart/form-data" id="mainform">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <select name="jk_jenazah" id="" class="form-control {{($errors->has('jk_jenazah'))?'is-invalid':''}}" >
                                        ...
                                        <option value="laki-laki" {{(old('jk_jenazah')=='laki-laki')?
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <select name="pekerjaan_id_jenazah" id="" class="form-control select2 {{($errors->has('pekerjaan_id_jenazah'))?'is-invalid':''}}" >
                                        ...
                                        <option value="{{$data->id}}" {{(old('pekerjaan_id_jenazah')==$data->id)?
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <textarea name="alamat_jenazah"
                                        class="form-control {{($errors->has('alamat_jenazah'))?'is-invalid':''}}">{{old('alamat_jenazah')}}</textarea>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <select name="provinsi_id_jenazah" id="" class="provinsi_jenazah form-control select2 {{($errors->has('provinsi_id_jenazah'))?'is-invalid':''}}" >
                                        ...
                                        <option value="{{$data->id}}" {{(old('provinsi_id_jenazah')==$data->id)?
                                        'selected':''}}>{{$data->nama}}</option>
                                        @endforeach    
                                    </select>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <select name="kewarganegaraan" id="" class="form-control select2 {{($errors->has('kewarganegaraan'))?'is-invalid':''}}" >
                                        ...
                                        <option value="wni" {{(old('kewarganegaraan')=='wni')?
                                        'selected':''}}>WNI</option>
                                        <option value="wna" {{(old('kewarganegaraan')=='wna')?
                                        'selected':''}}>WNA</option>
                                    </select>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <select name="keturunan" id="" class="form-control select2 {{($errors->has('keturunan'))?'is-invalid':''}}" >
                                        ...
                                        <option value="eropa" {{(old('keturunan')=='eropa')?
                                        'selected':''}}>Eropa</option>
                                        <option value="cina/timur asing lainnya" {{(old('keturunan')=='cina/timur asing lainnya')?
                                        'selected':''}}>Cina/timur asing lainnya</option>
                                        <option value="indonesia" {{(old('keturunan')=='indonesia')?
                                        'selected':''}}>Indonesia</option>
                                        <option value="indonesia nasrani" {{(old('keturunan')=='indonesia nasrani')?
                                        'selected':''}}>Indonesia Nasrani</option>
                                        <option value="lainnya" {{(old('keturunan')=='lainnya')?
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <select name="sebab_kematian" id="" class="form-control {{($errors->has('sebab_kematian'))?'is-invalid':''}}" >
                                        ...
                                        <option value="sakit biasa" {{(old('sebab_kematian')=='sakit biasa')?
                                        'selected':''}}>Sakit Biasa</option>
                                        <option value="tua" {{(old('sebab_kematian')=='tua')?'selected':''}}>Tua</option>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <select name="yang_menerangkan" id="" class="form-control {{($errors->has('yang_menerangkan'))?'is-invalid':''}}" >
                                        <option value="">Pilih Sebab Kematian</option>
                                        <option value="dokter" {{(old('yang_menerangkan')=='dokter')?
                                        ...
                                        <option value="kepolisian" {{(old('yang_menerangkan')=='wabah penyakit')?'selected':''}}>Wabah Penyakit</option>
                            ...
                            <div class="form-group mb-0 row">
                                ...
                                <div class="col-sm-9">
                                    <img src="{{asset('backend/images/default.jpg')}}" id="preview-file_sk_rs" alt=""
                                        width="200px">
                                    <input type="file" class="form-control {{($errors->has('file_sk_rs'))?'is-invalid':''}}" id="file_sk_rs" name="file_sk_rs" value="{{old('file_sk_rs')}}"
                            ...
                            <div class="form-group mb-0 row">
                                ...
                                <div class="col-sm-9">
                                    <img src="{{asset('backend/images/default.jpg')}}" id="preview-file_ktp_alm" alt=""
                                        width="200px">
                                    <input type="file" class="form-control {{($errors->has('file_ktp_alm'))?'is-invalid':''}}" id="file_ktp_alm" name="file_ktp_alm" value="{{old('file_ktp_alm')}}"
                                        accept="image/jpg,image/jpeg,image/png">
                            ...
                            <div class="form-group mb-0 row">
                                ...
                                <div class="col-sm-9">
                                    <img src="{{asset('backend/images/default.jpg')}}" id="preview-file_ktp_pelapor" alt=""
                                        width="200px">
                                    <input type="file" class="form-control {{($errors->has('file_ktp_pelapor'))?'is-invalid':''}}" id="file_ktp_pelapor" name="file_ktp_pelapor" value="{{old('file_ktp_pelapor')}}"
                                        accept="image/jpg,image/jpeg,image/png">
                            ...
                            <div class="form-group mb-0 row">
                                ...
                                <div class="col-sm-9">
                                    <img src="{{asset('backend/images/default.jpg')}}" id="preview-file_ktp_saksi" alt=""
                                        width="200px">
                                    <input type="file" class="form-control {{($errors->has('file_ktp_saksi'))?'is-invalid':''}}" id="file_ktp_saksi" name="file_ktp_saksi" value="{{old('file_ktp_saksi')}}"
                                        accept="image/jpg,image/jpeg,image/png">
