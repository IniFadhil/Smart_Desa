                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="card-header-action">
                            ...
                            <a href="{{route('backend.dokumen.skm.create')}}" class="btn btn-success btn-icon"><i
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped table-1">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>{{$i++}}</td>
                                        <td>{{$row->nik_jenazah}}</td>
                                        <td>{{$row->nama_jenazah}}</td>
                                        <td>{{\Carbon\Carbon::parse($row->tgl_lahir_jenazah)->translatedFormat('d M Y')}}</td>
                                        <td>{{\Carbon\Carbon::parse($row->tgl_kematian)->translatedFormat('d M Y')}}</td>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{route('backend.dokumen.skm.detail',['id' => $row->encodeHash($row->id)])}}"
...
<form action="{{route('backend.dokumen.skm.print')}}" method="post">
    {{csrf_field()}}
...
<form action="{{route('backend.dokumen.skm.delete')}}" method="post">
    {{csrf_field()}}
    <input type="hidden" class="id" value="" name="id">
