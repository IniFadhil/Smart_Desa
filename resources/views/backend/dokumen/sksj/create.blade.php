            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4>Form Tambah Pengajuan Surat Keterangan Sapu Jagat</h4>
                    </div>
                    <div class="card-body">
                        <form class="forms-sample" method="post" enctype="multipart/form-data" id="mainform">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control {{($errors->has('nama_pejabat'))?'is-invalid':''}}"
                                        placeholder="Masukan Nama Pejabat" name="nama_pejabat" value="{{old('nama_pejabat')}}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text"
                                        ...
                                        placeholder="Masukan Jabatan" name="jabatan" value="{{old('jabatan')}}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control {{($errors->has('nama_penduduk'))?'is-invalid':''}}"
                                        placeholder="Masukan Nama Penduduk" name="nama_penduduk" value="{{old('nama_penduduk')}}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="number"
                                        ...
                                        placeholder="Masukan No KTP/SIM" name="no_nik" value="{{old('no_nik')}}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="number" min="1"
                                        ...
                                        placeholder="Masukan Umur" name="umur" value="{{old('umur')}}">
                                    @if($errors->has('umur'))
                                    <div class="invalid-feedback">
                                        {{$errors->first('umur')}}
                                    </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <select class="form-control select2 {{($errors->has('pekerjaan_id'))?'is-invalid':''}}"
                                        ...
                                        <option value="{{$data->id}}" {{ ( old('pekerjaan_id') == $data->id) ? 'selected' : '' }}>
                                            {{$data->nama}}
                                        </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <textarea name="alamat_kantor" id="" cols="30" rows="10"
                                        class="form-control {{($errors->has('alamat_kantor'))?'is-invalid':''}}">{{old('alamat_kantor')}}</textarea>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text"
                                        ...
                                        placeholder="Masukan Untuk Keperluan" name="keperluan" value="{{old('keperluan')}}">
                            ...
                            <div class="card-footer text-right">
                                <a href="{{route('backend.dokumen.sksj')}}" class="btn btn-secondary">Batal</a>
