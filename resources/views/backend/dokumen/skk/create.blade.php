            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4>Form Tambah Pengajuan Surat Keterangan Kelahiran</h4>
                    </div>
                    <div class="card-body">
                        <form class="forms-sample" method="post" enctype="multipart/form-data" id="mainform">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text"
                                        ...
                                        placeholder="Masukan Nama Kepala Keluarga Anda" name="nama_kepala_keluarga" value="{{old('nama_kepala_keluarga')}}" >
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text"
                                        ...
                                        placeholder="Masukan No Kartu Keluarga Anda" name="no_kk" value="{{old('no_kk')}}" >
                                    @if($errors->has('no_kk'))
                                    <div class="invalid-feedback">
                                        {{$errors->first('no_kk')}}
                                    </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <select name="jk_bayi" id="" class="form-control {{($errors->has('jk_bayi'))?'is-invalid':''}}" >
                                        ...
                                        <option value="laki-laki" {{(old('jk_bayi')=='laki-laki')?
                                        'selected':''}}>Laki-laki</option>
                                        <option value="perempuan" {{(old('jk_bayi')=='perempuan')?'selected':''}}>Perempuan</option>
                                    </select>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <select name="tempat_dilahirkan" id="" class="form-control {{($errors->has('tempat_dilahirkan'))?'is-invalid':''}}" >
                                        ...
                                        <option value="rs/rb" {{(old('tempat_dilahirkan')=='rs/rb')?
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <select name="hari" id="" class="form-control {{($errors->has('hari'))?'is-invalid':''}}" >
                                        ...
                                        <option value="senin" {{(old('hari')=='senin')?
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <select name="jenis_kelahiran" id="" class="form-control {{($errors->has('jenis_kelahiran'))?'is-invalid':''}}" >
                                        ...
                                        <option value="tunggal" {{(old('jenis_kelahiran')=='tunggal')?
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <select name="penolong_kelahiran" id="" class="form-control {{($errors->has('penolong_kelahiran'))?'is-invalid':''}}" >
                                        <option value="">Pilih Jenis Kelahiran</option>
                                        <option value="dokter" {{(old('penolong_kelahiran')=='dokter')?
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text"
                                        ...
                                        placeholder="Masukan NIK Ibu" name="nik_ibu" value="{{old('nik_ibu')}}" >
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <select name="pekerjaan_id_ibu" id="" class="form-control select2 {{($errors->has('pekerjaan_id_ibu'))?'is-invalid':''}}" >
                                        ...
                                        <option value="{{$data->id}}" {{(old('pekerjaan_id_ibu')==$data->id)?
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <textarea name="alamat_ibu"
                                        class="form-control {{($errors->has('alamat_ibu'))?'is-invalid':''}}">{{old('alamat_ibu')}}</textarea>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <select name="provinsi_id_ibu" id="" class="provinsi_ibu form-control select2 {{($errors->has('provinsi_id_ibu'))?'is-invalid':''}}" >
                                        ...
                                        <option value="{{$data->id}}" {{(old('provinsi_id_ibu')==$data->id)?
                                        'selected':''}}>{{$data->nama}}</option>
                                        @endforeach    
                                    </select>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <select name="kewarganegaraan_ibu" id="" class="form-control select2 {{($errors->has('kewarganegaraan_ibu'))?'is-invalid':''}}" >
                                        ...
                                        <option value="wni" {{(old('kewarganegaraan_ibu')=='wni')?
                                        'selected':''}}>WNI</option>
                                        <option value="wna" {{(old('kewarganegaraan_ibu')=='wna')?
                                        'selected':''}}>WNA</option>
                                    </select>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control {{($errors->has('kebangsaan_ibu'))?'is-invalid':''}}"
                                        placeholder="Masukan Kebangsaan Ibu" name="kebangsaan_ibu" value="{{old('kebangsaan_ibu')}}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text"
                                        ...
                                        value="{{old('tgl_pencatatan_perkawinan')}}" >
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text"
                                        ...
                                        placeholder="Masukan NIK Ayah" name="nik_ayah" value="{{old('nik_ayah')}}" >
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <select name="pekerjaan_id_ayah" id="" class="form-control select2 {{($errors->has('pekerjaan_id_ayah'))?'is-invalid':''}}" >
                                        ...
                                        @foreach($pekerjaan as $data)
                                        <option value="{{$data->id}}" {{(old('pekerjaan_id_ayah')==$data->id)?
                                        'selected':''}}>{{$data->nama}}</option>
                                        @endforeach
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <textarea name="alamat_ayah"
                                        class="form-control {{($errors->has('alamat_ayah'))?'is-invalid':''}}">{{old('alamat_ayah')}}</textarea>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <select name="provinsi_id_ayah" id="" class="provinsi_ayah form-control select2 {{($errors->has('provinsi_id_ayah'))?'is-invalid':''}}" >
                                        <option value="">Pilih Provinsi</option>
                                        @foreach($provinsi as $data)
                                        <option value="{{$data->id}}" {{(old('provinsi_id_ayah')==$data->id)?
                                        'selected':''}}>{{$data->nama}}</option>
                                        @endforeach    
                                    </select>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <select name="kewarganegaraan_ayah" id="" class="form-control select2 {{($errors->has('kewarganegaraan_ayah'))?'is-invalid':''}}" >
                                        <option value="">Pilih Kewarganegaraan</option>  
                                        <option value="wni" {{(old('kewarganegaraan_ayah')=='wni')?
                                        'selected':''}}>WNI</option>
                                        <option value="wna" {{(old('kewarganegaraan_ayah')=='wna')?
                                        'selected':''}}>WNA</option>
                                    </select>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control {{($errors->has('kebangsaan_ayah'))?'is-invalid':''}}"
                                        placeholder="Masukan Kebangsaan Ibu" name="kebangsaan_ayah" value="{{old('kebangsaan_ayah')}}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text"
                                        ...
                                        placeholder="Masukan NIK Pelapor" name="nik_pelapor" value="{{old('nik_pelapor')}}" >
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <select name="jk_pelapor" id="" class="form-control select2 {{($errors->has('jk_pelapor'))?'is-invalid':''}}" >
                                        ...
                                        <option value="laki-laki" {{(old('jk_pelapor')=='laki-laki')?
                                        'selected':''}}>Laki-laki</option>
                                        <option value="perempuan" {{(old('jk_pelapor')=='perempuan')?
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <select name="pekerjaan_id_pelapor" id="" class="form-control select2 {{($errors->has('pekerjaan_id_pelapor'))?'is-invalid':''}}" >
                                        ...
                                        @foreach($pekerjaan as $data)
                                        <option value="{{$data->id}}" {{(old('pekerjaan_id_pelapor')==$data->id)?
                                        'selected':''}}>{{$data->nama}}</option>
                                        @endforeach
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <textarea name="alamat_pelapor"
                                        class="form-control {{($errors->has('alamat_pelapor'))?'is-invalid':''}}">{{old('alamat_pelapor')}}</textarea>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <select name="provinsi_id_pelapor" id="" class="provinsi_pelapor form-control select2 {{($errors->has('provinsi_id_pelapor'))?'is-invalid':''}}" >
                                        <option value="">Pilih Provinsi</option>
                                        @foreach($provinsi as $data)
                                        <option value="{{$data->id}}" {{(old('provinsi_id_pelapor')==$data->id)?
                                        'selected':''}}>{{$data->nama}}</option>
                                        @endforeach    
                                    </select>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <select name="jk_saksi1" id="" class="form-control select2 {{($errors->has('jk_saksi1'))?'is-invalid':''}}" >
                                        ...
                                        <option value="laki-laki" {{(old('jk_saksi1')=='laki-laki')?
                                        'selected':''}}>Laki-laki</option>
                                        <option value="perempuan" {{(old('jk_saksi1')=='perempuan')?
                                        'selected':''}}>Perempuan</option>
                                    </select>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <select name="pekerjaan_id_saksi1" id="" class="form-control select2 {{($errors->has('pekerjaan_id_saksi1'))?'is-invalid':''}}" >
                                        ...
                                        @foreach($pekerjaan as $data)
                                        <option value="{{$data->id}}" {{(old('pekerjaan_id_saksi1')==$data->id)?
                                        'selected':''}}>{{$data->nama}}</option>
                                        @endforeach
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <textarea name="alamat_saksi1"
                                        class="form-control {{($errors->has('alamat_saksi1'))?'is-invalid':''}}">{{old('alamat_saksi1')}}</textarea>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <select name="provinsi_id_saksi1" id="" class="provinsi_saksi1 form-control select2 {{($errors->has('provinsi_id_saksi1'))?'is-invalid':''}}" >
                                        <option value="">Pilih Provinsi</option>
                                        @foreach($provinsi as $data)
                                        <option value="{{$data->id}}" {{(old('provinsi_id_saksi1')==$data->id)?
                                        'selected':''}}>{{$data->nama}}</option>
                                        @endforeach    
                                    </select>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <select name="jk_saksi2" id="" class="form-control select2 {{($errors->has('jk_saksi2'))?'is-invalid':''}}" >
                                        <option value="">Pilih Jenis Kelamin</option>
                                        <option value="laki-laki" {{(old('jk_saksi2')=='laki-laki')?
                                        'selected':''}}>Laki-laki</option>
                                        <option value="perempuan" {{(old('jk_saksi2')=='perempuan')?
                                        'selected':''}}>Perempuan</option>
                                    </select>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <select name="pekerjaan_id_saksi2" id="" class="form-control select2 {{($errors->has('pekerjaan_id_saksi2'))?'is-invalid':''}}" >
                                        ...
                                        @foreach($pekerjaan as $data)
                                        <option value="{{$data->id}}" {{(old('pekerjaan_id_saksi2')==$data->id)?
                                        'selected':''}}>{{$data->nama}}</option>
                                        @endforeach
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <textarea name="alamat_saksi2"
                                        class="form-control {{($errors->has('alamat_saksi2'))?'is-invalid':''}}">{{old('alamat_saksi2')}}</textarea>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <select name="provinsi_id_saksi2" id="" class="provinsi_saksi2 form-control select2 {{($errors->has('provinsi_id_saksi2'))?'is-invalid':''}}" >
                                        <option value="">Pilih Provinsi</option>
                                        @foreach($provinsi as $data)
                                        <option value="{{$data->id}}" {{(old('provinsi_id_saksi2')==$data->id)?
                                        'selected':''}}>{{$data->nama}}</option>
                                        @endforeach    
                                    </select>
                            ...
                            <div class="form-group mb-0 row">
                                ...
                                <div class="col-sm-9">
                                    <img src="{{asset('backend/images/default.jpg')}}" id="preview-file_sk_kelahiran" alt=""
                                        width="200px">
                                    <input type="file" class="form-control {{($errors->has('file_sk_kelahiran'))?'is-invalid':''}}" id="file_sk_kelahiran" name="file_sk_kelahiran" value="{{old('file_sk_kelahiran')}}"
                            ...
                            <div class="form-group mb-0 row">
                                ...
                                <div class="col-sm-9">
                                    <img src="{{asset('backend/images/default.jpg')}}" id="preview-file_surat_nikah" alt=""
                                        width="200px">
                                    <input type="file" class="form-control {{($errors->has('file_surat_nikah'))?'is-invalid':''}}" id="file_surat_nikah" name="file_surat_nikah" value="{{old('file_surat_nikah')}}"
                                        accept="image/jpg,image/jpeg,image/png">
                            ...
                            <div class="form-group mb-0 row">
                                ...
                                <div class="col-sm-9">
                                    <img src="{{asset('backend/images/default.jpg')}}" id="preview-file_kk" alt=""
                                        width="200px">
                                    <input type="file" class="form-control {{($errors->has('file_kk'))?'is-invalid':''}}" id="file_kk" name="file_kk" value="{{old('file_kk')}}"
                                        accept="image/jpg,image/jpeg,image/png">
                            ...
                            <div class="form-group mb-0 row">
                                ...
                                <div class="col-sm-9">
                                    <img src="{{asset('backend/images/default.jpg')}}" id="preview-file_ibu" alt=""
                                        width="200px">
                                    <input type="file" class="form-control {{($errors->has('file_ibu'))?'is-invalid':''}}" id="file_ibu" name="file_ibu" value="{{old('file_ibu')}}"
                                        accept="image/jpg,image/jpeg,image/png">
                            ...
                            <div class="form-group mb-0 row">
                                ...
                                <div class="col-sm-9">
                                    <img src="{{asset('backend/images/default.jpg')}}" id="preview-file_ayah" alt=""
                                        width="200px">
                                    <input type="file" class="form-control {{($errors->has('file_ayah'))?'is-invalid':''}}" id="file_ayah" name="file_ayah" value="{{old('file_ayah')}}"
                                        accept="image/jpg,image/jpeg,image/png">
                            ...
                            <div class="card-footer text-right">
                                <a href="{{route('backend.dokumen.skk')}}" class="btn btn-secondary">Batal</a>
