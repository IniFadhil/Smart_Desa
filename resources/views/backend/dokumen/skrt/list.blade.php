            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4>List Pengajuan Surat Keterangan Riwayat Tanah</h4>
                        <div class="card-header-action">
                            ...
                            <a href="{{route('backend.dokumen.skrt.create')}}" class="btn btn-success btn-icon"><i
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{route('backend.dokumen.skrt.detail',['id' => $row->encodeHash($row->id)])}}"
...
<form action="{{route('backend.dokumen.skrt.print')}}" method="post">
    {{csrf_field()}}
...
<form action="{{route('backend.dokumen.skrt.delete')}}" method="post">
    {{csrf_field()}}
    <input type="hidden" class="id" value="" name="id">
