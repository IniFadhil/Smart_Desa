...
<section class="section">
    <div class="section-header">
        ...
        <div class="section-header-breadcrumb">
            ...
            <div class="breadcrumb-item"><a href="{{route('backend.dokumen.skrt')}}"> Surat Keterangan Riwayat Tanah</a></div>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4>Form Tambah Pengajuan Surat Keterangan Riwayat Tanah</h4>
                    </div>
                    <div class="card-body">
                        <form class="forms-sample" method="post" enctype="multipart/form-data" id="mainform">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control {{($errors->has('nama_pemilik'))?'is-invalid':''}}"
                                        placeholder="Masukan Nama Pemilik" name="nama_pemilik" value="{{old('nama_pemilik')}}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="number" min="0"
                                        ...
                                        placeholder="Masukan NIK pemilik" name="nik_pemilik" value="{{old('nik_pemilik')}}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text"
                                        ...
                                        placeholder="Masukan No Sertifikat" name="no_sertifikat" value="{{old('no_sertifikat')}}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <select class="form-control select2 {{($errors->has('berdasarkan2'))?'is-invalid':''}}"
                                        name="berdasarkan2">
                                        <option value="">-- Pilih Berdasarkan --</option>
                                        <option value="jual beli" {{ ( old('berdasarkan2') == 'jual beli') ? 'selected' : '' }}>
                                            Jual beli
                                        </option>
                                        <option value="hibah" {{ ( old('berdasarkan2') == 'hibah') ? 'selected' : '' }}>
                                            Hibah
                                        </option>
                                        <option value="waris" {{ ( old('berdasarkan2') == 'waris') ? 'selected' : '' }}>
                                            Waris
                                        </option>
                                    </select>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <select class="form-control select2 {{($errors->has('berdasarkan3'))?'is-invalid':''}}"
                                        name="berdasarkan3">
                                        <option value="">-- Pilih Berdasarkan --</option>
                                        <option value="jual beli" {{ ( old('berdasarkan3') == 'jual beli') ? 'selected' : '' }}>
                                            Jual beli
                                        </option>
                                        <option value="hibah" {{ ( old('berdasarkan3') == 'hibah') ? 'selected' : '' }}>
                                            Hibah
                                        </option>
                                        <option value="waris" {{ ( old('berdasarkan3') == 'waris') ? 'selected' : '' }}>
                                            Waris
                                        </option>
                                    </select>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <select class="form-control select2 {{($errors->has('berdasarkan4'))?'is-invalid':''}}"
                                        name="berdasarkan4">
                                        <option value="">-- Pilih Berdasarkan --</option>
                                        <option value="jual beli" {{ ( old('berdasarkan4') == 'jual beli') ? 'selected' : '' }}>
                                            Jual beli
                                        </option>
                                        <option value="hibah" {{ ( old('berdasarkan4') == 'hibah') ? 'selected' : '' }}>
                                            Hibah
                                        </option>
                                        <option value="waris" {{ ( old('berdasarkan4') == 'waris') ? 'selected' : '' }}>
                                            Waris
                                        </option>
                                    </select>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text"
                                        ...
                                        placeholder="Masukan No SPPT" name="no_sppt"
                                        value="{{old('no_sppt')}}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text"
                                        class="form-control {{($errors->has('blok'))?'is-invalid':''}}"
                                        placeholder="Masukan Blok" name="blok"
                                        value="{{old('blok')}}">
                                    @if($errors->has('blok'))
                                    <div class="invalid-feedback">
                                        {{$errors->first('blok')}}
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text"
                                        class="form-control {{($errors->has('persil'))?'is-invalid':''}}"
                                        placeholder="Masukan persil" name="persil"
                                        value="{{old('persil')}}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text"
                                        class="form-control {{($errors->has('luas'))?'is-invalid':''}}"
                                        placeholder="Masukan Luas (m2)" name="luas"
                                        value="{{old('luas')}}">
                                    @if($errors->has('luas'))
                                    <div class="invalid-feedback">
                                        {{$errors->first('luas')}}
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text"
                                        ...
                                        placeholder="Masukan NIK" name="nik_saksi1"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text"
                                        ...
                                        placeholder="Masukan NIK" name="nik_saksi2"
                            ...
                            <div class="form-group mb-0 row">
                                ...
                                <div class="col-sm-9">
                                    <img src="{{asset('backend/images/default.jpg')}}" id="preview-surat_tanah" alt=""
                                        width="200px">
                                    <input type="file" class="form-control {{($errors->has('surat_tanah'))?'is-invalid':''}}" id="surat_tanah" name="surat_tanah" value="{{old('surat_tanah')}}"
                            ...
                            <div class="form-group mb-0 row">
                                ...
                                <div class="col-sm-9">
                                    <img src="{{asset('backend/images/default.jpg')}}" id="preview-surat_pajak_tanah" alt=""
                                        width="200px">
                                    <input type="file" class="form-control {{($errors->has('surat_pajak_tanah'))?'is-invalid':''}}" id="surat_pajak_tanah" name="surat_pajak_tanah" value="{{old('surat_pajak_tanah')}}"
                                        accept="image/jpg,image/jpeg,image/png">
                            ...
                            <div class="card-footer text-right">
                                <a href="{{route('backend.dokumen.skrt')}}" class="btn btn-secondary">Batal</a>
