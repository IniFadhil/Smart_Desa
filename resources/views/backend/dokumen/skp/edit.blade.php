...
@if(Session::get('permission')->update == 1 && $skp->status == 1)
<section class="section">
    <div class="section-header">
        <h1>Surat Keterangan Penghasilan</h1>
        <div class="section-header-breadcrumb">
            <div class="breadcrumb-item">Dokumen</div>
            <div class="breadcrumb-item"><a href="{{route('backend.dokumen.skp')}}"> Surat Keterangan Penghasilan</a></div>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4>Form Edit Surat Keterangan Penghasilan</h4>
                    </div>
                    <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <input type="text" class="form-control {{($errors->has('no_surat'))?'is-invalid':''}}"
                                        placeholder="Masukan Nomor Surat" name="no_surat" value="{{old('no_surat',$skp->no_surat)}}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <select class="form-control select2 {{($errors->has('user_id'))?'is-invalid':''}}"
                                        ...
                                        <option value="{{$data->id}}" {{ ( old('user_id',$skp->user_id) == $data->id) ? 'selected' : '' }}>{{$data->nama_lengkap}}
                                        </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text"
                                        ...
                                        placeholder="Masukan Nama Anda" name="nama" value="{{old('nama',$skp->nama)}}" >
                                    @if($errors->has('nama'))
                                    <div class="invalid-feedback">
                                        {{$errors->first('nama')}}
                                    </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text"
                                        ...
                                        value="{{old('tempat_lahir',$skp->tempat_lahir)}}" >
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text"
                                        ...
                                        value="{{old('tgl_lahir',$skp->tgl_lahir)}}" >
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <select name="jk" id="" class="form-control {{($errors->has('tgl_lahir'))?'is-invalid':''}}" >
                                        ...
                                        <option value="laki-laki" {{(old('jk',$skp->jk)=='laki-laki')?
                                        'selected':''}}>Laki-laki</option>
                                        <option value="perempuan" {{(old('jk',$skp->jk)=='perempuan')?'selected':''}}>Perempuan</option>
                                    </select>
                                    @if($errors->has('jk'))
                                    <div class="invalid-feedback">
                                        {{$errors->first('jk')}}
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <select name="pekerjaan_id" id="" class="form-control {{($errors->has('pekerjaan_id'))?'is-invalid':''}}" >
                                        ...
                                        <option value="{{$data->id}}" {{(old('pekerjaan_id',$skp->pekerjaan_id)==$data->id)?
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="number" min='0'
                                        ...
                                        value="{{old('jumlah_tanggungan',$skp->jumlah_tanggungan)}}" >
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <textarea name="alamat" id="" cols="30" rows="10"
                                        class="form-control {{($errors->has('alamat'))?'is-invalid':''}}">{{old('alamat',$skp->alamat)}}</textarea>
                            ...
                            <div class="form-group mb-0 row">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <img src="<?php echo (!empty($skp->slip_gaji) ? $img . '/dokumen/skp/slip_gaji/' . $skp->slip_gaji : $img . '/default.jpg') ?>"
                                        id="preview-slip_gaji" style="width: 200px">
...
@else
<script>
    window.location.href = "{{route('backend.dokumen.skp')}}"
