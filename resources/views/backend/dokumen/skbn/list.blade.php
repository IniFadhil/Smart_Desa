                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="card-header-action">
                            ...
                            <a href="{{route('backend.dokumen.skbn.create')}}" class="btn btn-success btn-icon"><i
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped table-1">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>{{$i++}}</td>
                                        <td>{{$row->skbnDetail[0]->jenis_dok}}</td>
                                        <td>{{$row->skbnDetail[1]->jenis_dok}}</td>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{route('backend.dokumen.skbn.detail',['id' => $row->encodeHash($row->id)])}}"
...
<form action="{{route('backend.dokumen.skbn.print')}}" method="post">
    {{csrf_field()}}
