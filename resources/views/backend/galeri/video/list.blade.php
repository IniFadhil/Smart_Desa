                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="card-header-action">
                            ...
                            <a href="{{route('backend.galeri.video.create')}}" class="btn btn-success btn-icon"><i
                                ...
                                <tbody>
                                  ...
                                  <tr>
                                      ...
                                      <td>
                                        ...
                                        <a href="{{route('backend.galeri.video.edit',['id' => $row->encodeHash($row->id)])}}"
                                        ...
                                        <a href="{{route('backend.galeri.video.detail',['id' => $row->encodeHash($row->id)])}}"
...
<form action="{{route('backend.galeri.video.active')}}" method="post">
    {{csrf_field()}}
...
<form action="{{route('backend.galeri.video.inactive')}}" method="post">
    {{csrf_field()}}
    <input type="hidden" class="id" value="" name="id">
