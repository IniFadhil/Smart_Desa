                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="card-header-action">
                            ...
                            <a href="{{route('backend.informasi.agenda.create')}}" class="btn btn-success btn-icon"><i
                            ...
                            <table class="table table-striped table-1">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{\Carbon\Carbon::parse($row->start_date)->translatedFormat('d M Y H:m')}}</td>
                                        <td>
                                            <span
                                        ...
                                        <td>
                                            ...
                                            <a href="{{route('backend.informasi.agenda.edit',['id' => $row->encodeHash($row->id)])}}"
                                            ...
                                            <a href="{{route('backend.informasi.agenda.detail',['id' => $row->encodeHash($row->id)])}}"
...
<form action="{{route('backend.informasi.agenda.active')}}" method="post">
    {{csrf_field()}}
...
<form action="{{route('backend.informasi.agenda.inactive')}}" method="post">
    {{csrf_field()}}
    <input type="hidden" class="id" value="" name="id">
...
<!-- <form action="{{route('backend.informasi.agenda')}}" method="post" enctype="multipart/form-data">
    {{csrf_field()}}
