                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="card-header-action">
                            ...
                            <a href="{{route('backend.informasi.infoGrafis.create')}}" class="btn btn-success btn-icon"><i
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{route('backend.informasi.infoGrafis.edit',['id' => $row->encodeHash($row->id)])}}"
                                            ...
                                            <a href="{{route('backend.informasi.infoGrafis.detail',['id' => $row->encodeHash($row->id)])}}"
...
<form action="{{route('backend.informasi.infoGrafis.active')}}" method="post">
    {{csrf_field()}}
...
<form action="{{route('backend.informasi.infoGrafis.inactive')}}" method="post">
    {{csrf_field()}}
    <input type="hidden" class="id" value="" name="id">
