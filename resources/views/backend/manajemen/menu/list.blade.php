<x-backend.layouts.app>
    ...
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-2xl font-semibold text-gray-700">Daftar Menu</h1>
        {{-- Tombol diubah menjadi hijau agar sama dengan Modul --}}
        <a href="{{ route('backend.manajemen.menu.create') }}"
        ...
        <div class="overflow-x-auto">
            <table class="min-w-full bg-white">
                ...
                <tbody class="divide-y divide-gray-200">
                    @forelse($menus as $row)
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-center">
                                {{-- Urutan dan gaya tombol disamakan dengan Modul --}}
                                <div class="flex justify-center items-center space-x-4">
                                    <a href="{{ route('backend.manajemen.menu.show', $row) }}"
                                    ...
                                    <a href="{{ route('backend.manajemen.menu.edit', $row) }}"
                                    ...
                                    <form action="{{ route('backend.manajemen.menu.toggleStatus', $row) }}"
                    ...
                    @empty
                        <tr>
                            <td colspan="5" class="px-6 py-4 text-center text-sm text-gray-500">Tidak ada data untuk
                                ditampilkan.</td>
                        </tr>
                    @endforelse
                </tbody>
