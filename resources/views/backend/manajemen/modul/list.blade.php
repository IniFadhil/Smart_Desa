<x-backend.layouts.app>
    ...
    <div class="flex justify-between items-center mb-6">
        ...
        <a href="{{ route('backend.manajemen.modul.create') }}"
        ...
        <div class="overflow-x-auto">
            <table class="min-w-full bg-white">
                ...
                <tbody class="divide-y divide-gray-200">
                    @forelse($modul as $row)
                        <tr class="hover:bg-gray-50">
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{{ $loop->iteration }}</td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">
                                {{ $row->name }}</td>
                            <td class="px-6 py-4 whitespace-nowrap text-lg text-gray-700">{!! $row->icon ?? '-' !!}</td>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-center">
                                <div class="flex justify-center items-center space-x-4">
                                    <a href="{{ route('backend.manajemen.modul.show', $row) }}"
                                    ...
                                    <a href="{{ route('backend.manajemen.modul.edit', $row) }}"
                                    ...
                                    <form action="{{ route('backend.manajemen.modul.toggleStatus', $row) }}"
