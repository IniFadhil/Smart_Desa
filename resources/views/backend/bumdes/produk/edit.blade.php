                ...
                <div class="card">
                    <form method="post" enctype="multipart/form-data" id="mainform">
                        ...
                        <div class="card-header">
                            <h4>Form Edit Produk BUMDES</h4>
                        </div>
                        <div class="card-body">
                            <div class="form-group row">
                                <label class="col-sm-3 col-form-label">BUMDES</label>
                                <div class="col-sm-9">
                                    <select name="bumdes_id" id="" class="form-control select2 {{($errors->has('bumdes_id'))?'is-invalid':''}}" >                                        
                                        @foreach($bumdes as $data)
                                        <option value="{{$data->id}}" {{(old('bumdes_id')==$data->id)?'selected':''}}>{{$data->name}}</option>
                                        @endforeach
                                    </select>
                                    @if($errors->has('bumdes_id'))
                                    <div class="invalid-feedback">
                                        {{$errors->first('bumdes_id')}}
                                    </div>
                                    @endif
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control {{($errors->has('short_description'))?'is-invalid':''}}"
                                        name="short_description" value="{{old('short_description',$produk->short_description)}}">
                            ...
                            <div class="form-group mb-0 row">
                                ...
                                <div class="col-sm-9">
                                    <textarea type="text"
                                        ...
                                        id="description" name="description">{{old('description',$produk->description)}}</textarea>
                                </div>
                            ...
                            <div class="form-group mb-0 row">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <img src="<?php echo (!empty($produk->img) ? $img . '/bumdes/produk/' . $produk->img : $img . '/default.jpg') ?>"
                                        id="preview-img" style="width: 200px">
                                    <input type="file" class="form-control {{($errors->has('img'))?'is-invalid':''}}"
                                        id="img" name="img" value="{{$produk->img}}"
                            ...
                            <div class="form-group mb-0 row">
                                ...
                                <div class="col-sm-9">
                                    <select name="status" class="form-control select2">
                                        <option value="show" {{(old('status',$produk->status) == 'show')?'selected':''}}>Aktif
                                        </option>
                                        <option value="hide" {{(old('status',$produk->status) == 'hide')?'selected':''}}>Tidak
                                            Aktif
                                        </option>
                                    </select>
                        ...
                        <div class="card-footer text-right">
                            <a href="{{route('backend.bumdes.produk')}}" class="btn btn-secondary">Batal</a>
...
@else
<script>
    window.location.href = "{{route('backend.bumdes.produk')}}"
