                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="card-header-action">
                            ...
                            <a href="{{route('backend.bumdes.produk.create')}}" class="btn btn-success btn-icon"><i class="fas fa-plus-circle"></i> Tambah</a>
                            @endif
                        </div>
                    </div>
                    <div class="card-body">
                            ...
                            <table class="table table-striped table-1">
                                ...
                                <tbody>
                                  ...
                                  <tr>
                                      <td>{{$i++}}</td>
                                      <td>{{$row->name}}</td>
                                      <td>{{$row->bumdes->name}}</td>
                                      <td>{{$row->status}}</td>
                                      <td>
                                        @if(Session::get('permission')->update == 1)
                                        <a href="{{route('backend.bumdes.produk.edit',['id' => $row->encodeHash($row->id)])}}"
                                        ...
                                        <a href="{{route('backend.bumdes.produk.detail',['id' => $row->encodeHash($row->id)])}}"
...
<form action="{{route('backend.bumdes.produk.active')}}" method="post">
    {{csrf_field()}}
...
<form action="{{route('backend.bumdes.produk.inactive')}}" method="post">
    {{csrf_field()}}
    <input type="hidden" class="id" value="" name="id">
