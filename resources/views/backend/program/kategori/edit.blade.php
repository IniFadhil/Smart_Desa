                ...
                <div class="card">
                    <form method="post" enctype="multipart/form-data" id="mainform">
                        ...
                        <div class="card-header">
                            <h4>Form Edit Kategori Program</h4>
                        </div>
                        <div class="card-body">
                        ...
                        <div class="card-footer text-right">
                            <a href="{{route('backend.program.category')}}" class="btn btn-secondary">Batal</a>
...
@else
<script>
    window.location.href = "{{route('backend.program.category')}}"
