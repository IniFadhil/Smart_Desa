<x-layouts.guest>
    <div class="w-full sm:max-w-md px-6 py-8 bg-white shadow-md overflow-hidden sm:rounded-lg">
        ...
        <div class="text-center mb-6">
            ...
            <p class="text-gray-500 mt-1">Sudah punya akun? <a href="{{ route('login') }}"
        ...
        <form method="POST" action="{{ route('register') }}">
            @csrf
            <div>
                <input class="block mt-1 w-full border-gray-300 rounded-md shadow-sm" type="text" name="nik"
                    required placeholder="NIK" />
            </div>

            <div class="mt-4">
                <input class="block mt-1 w-full border-gray-300 rounded-md shadow-sm" type="text" name="name"
                    required placeholder="Nama Lengkap" />
            </div>

            <div class="mt-4">
                <input class="block mt-1 w-full border-gray-300 rounded-md shadow-sm" type="email" name="email"
            ...
            <div class="mt-4">
                <input class="block mt-1 w-full border-gray-300 rounded-md shadow-sm" type="password"
