<x-layouts.guest>
    <div class="w-full sm:max-w-md px-6 py-8 bg-white shadow-md overflow-hidden sm:rounded-lg">
        ...
        <div class="text-center mb-6">
            ...
            <p class="text-gray-500 mt-1">Belum daftar? <a href="{{ route('register') }}" class="text-green-600 hover:underline">Daftar</a></p>
        </div>
        ...
        <form method="POST" action="{{ route('login') }}">
            ...
            <!-- NIK -->
            <div>
                <input class="block mt-1 w-full border-gray-300 rounded-md shadow-sm" type="text" name="email" required autofocus placeholder="NIK" />
            </div>
